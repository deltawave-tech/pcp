...
pub const MemoryGraphStore = struct {
    ...
    pub fn applyMutation(self: *Self, gateway_id: []const u8, lab_id: []const u8, mutation: types.MutationRequest, mutation_type: types.MutationType, visibility: types.Visibility, provenance_json: []const u8, now: i64) !void {
        ...
        try self.ensureNamespaceLocked(gateway_id, lab_id, mutation.namespace_id, visibility, now);
    ...
    fn ensureNamespaceLocked(self: *Self, gateway_id: []const u8, lab_id: []const u8, namespace_id: []const u8, visibility: types.Visibility, now: i64) !void {
        ...
        try self.namespaces.append(.{
            ...
            .owner_gateway_id = try self.allocator.dupe(u8, gateway_id),
            .owner_lab_id = try self.allocator.dupe(u8, lab_id),
