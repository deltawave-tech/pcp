...
pub const c = struct {
    ...
    pub const mlirIntegerAttrGetValueInt = mlir_c.mlirIntegerAttrGetValueInt;
    pub const integerAttrGetValueInt = mlir_c.mlirIntegerAttrGetValueInt;
    ...
    pub const mlirBF16TypeGet = mlir_c.mlirBF16TypeGet;
    pub const floatTypeGetBF16 = mlir_c.mlirBF16TypeGet;
