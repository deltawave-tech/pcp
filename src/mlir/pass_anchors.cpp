// CAPI registration for dialects needed by PCP
// These must be defined here because libIREECompiler.dylib does not export them
...
MLIR_DEFINE_CAPI_DIALECT_REGISTRATION(Tensor, tensor, mlir::tensor::TensorDialect)
